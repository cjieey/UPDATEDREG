...
public class Regfrm extends javax.swing.JFrame {
    ...
    private void btnRegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegActionPerformed
        ...
        String filePath = "C:\\Users\\WS\\Documents\\NetBeansProjects\\LOGINGUI-main\\GUILOGIN\\DATA\\" + txtEmail.getText() + ".txt";
        ...
        if (Files.exists(Paths.get(filePath))) {
            ...
            try{
                BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\WS\\Documents\\NetBeansProjects\\LOGINGUI-main\\GUILOGIN\\DATA\\"+txtEmail.getText()+".txt"));
